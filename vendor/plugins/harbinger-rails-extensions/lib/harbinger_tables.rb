module HarbingerRailsExtensions
  ...
  class HarbingerTable
    ...
    def column(col_name, opts={}, &blk)
      @columns.push(HarbingerTableColumn.new(col_name, opts, &blk))
    end
  ...
  module Helpers
    def harbinger_table_for(list, html_opts = {}, &blk)
      html_tbl = HarbingerTable.new(list, html_opts)
