@patientfloew @Browser @50314 @System
Feature: 51079_VerifyEditExistingResouceGroup
  ...
  Scenario: 51079_VerifyEditExistingResouceGroup
    ...
    Then add Resources "VHO-CT CT-3" and "VHO-CT CT-3" into the group
    ...
    Then add Resources "MR 1" and "MR 2" into the group
    And user clicks on "Calendar" tab
    And Verify the New Group with Resource "MR 1" and "MR 2" is displayed
